...
namespace ccblas {
	 ...
	 * @param prefetch_amount_x, prefetch_amount_y number of elements to prefetch into cache
	 * 
	 ...
	 * @param incy step-size of `y`
	 * @param prefetch_amount_y number of elements to prefetch into cache
	 * 
	 * @return status code - 1 for success, 0 for failure
	 */
	 ...
	 * @param incy step-size of y
	 * @param prefetch_amount_x, prefetch_amount_y, prefetch_amount_A number of elements to prefetch into cache
	 * 
	 * @return status code - 1 for success, 0 for failure
	 * 
	 */
	 ...
	 * @param prefetch_amount_A, prefetch_amount_B, prefetch_amount_C number of elements to prefetch into cache
	 * 
	 * @return status code - 1 for success, 0 for failure
	 * 
	 */
	int gemm(
		...
		int prefetch_amount_A, int prefetch_amount_B, int prefetch_amount_C
	);
}