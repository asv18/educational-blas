...
TEST(Level1_axpy_baseline, basic_axpy_baseline) {
	long n = 3;
...
TEST(Level1_axpy_baseline, hard_axpy_baseline) {
	long n = 100000;
...
TEST(Level1_axpy_baseline, skips_axpy_baseline) {
	long nx = 50, ny = 10;
...
TEST(Level1_scal_baseline, hard_scal_baseline) {
	long n = 100000;
...
TEST(Level1_scal_baseline, skips_scal_baseline) {
	long n = 100000;
	int incy = 100;
...
TEST(Level1_dot_baseline, basic_dot_baseline) {
	long n = 2;
...
TEST(Level1_dot_baseline, skips_dot_baseline) {
...
TEST(Level1_nrm2_baseline, skips_nrm2_baseline) {
	long n = 100000;
